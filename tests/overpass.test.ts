// Coverage for the taxonomy-derived Overpass area selectors. Salvaged from a
// parallel development branch that implemented the same countrywide coverage,
// kept here so that work isn't lost when the branches were consolidated.
